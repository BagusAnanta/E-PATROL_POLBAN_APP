package com.annas.e_patrolpolbanapp.view.absen
...
import com.annas.e_patrolpolbanapp.BuildConfig
import com.annas.e_patrolpolbanapp.R
import com.annas.e_patrolpolbanapp.utils.BitmapManager.bitmapToBase64
...
import com.annas.e_patrolpolbanapp.viewmodel.AbsenViewModel
...
class AbsenActivity : AppCompatActivity() {
    ...
    private fun setUploadData() {
        btnMasuk.setOnClickListener {
            ...
            if (strFilePath.equals(null) || strNama.isEmpty() || strCurrentLocation.isEmpty() || strTanggal.isEmpty() || strKeterangan.isEmpty()) {
                Toast.makeText(this@AbsenActivity,
